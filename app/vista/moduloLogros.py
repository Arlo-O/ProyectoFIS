...
def create_category_box(parent, title, subcategories):
    ...
    # Lista de subcategorías (simulada)
...
# ======================================================================
# --- FUNCIÓN PRINCIPAL: GESTIÓN DE LOGROS/CATEGORÍAS ---
# ======================================================================

def create_achievements_manager(master, nav_commands):
    """Crea la interfaz de Gestión de Logros/Categorías."""
    ...
    # 1. BARRA LATERAL (SIDEBAR ADAPTADA)
    ...
    # Opciones de Navegación Lateral (usamos una sola opción activa, simulando la vista principal)
    ...
    # Footer (Volver al Dashboard) — usar la función que retorna el dashboard según el rol
